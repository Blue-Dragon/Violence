...
public class A7 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        magMore = findViewById(R.id.mag_more7);
        magLess = findViewById(R.id.mag_less7);
        tv = findViewById(R.id.tv_a7);
